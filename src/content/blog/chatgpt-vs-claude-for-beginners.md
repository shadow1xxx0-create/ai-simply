...
faqs:
  ...
  - question: "Is Claude smarter than ChatGPT?"
    answer: "It depends on the task. On many writing and reasoning benchmarks in 2025-2026, Claude's latest models perform comparably or slightly better than OpenAI's. For coding, they're roughly neck and neck. ChatGPT (via GPT-4o) has better image capabilities and more integrations. Neither is universally smarter — they're different tools."
  - question: "Which is better for writing?"
    answer: "Claude is widely preferred for writing tasks. It tends to write in a more natural, human-sounding style and is better at following specific style instructions. ChatGPT is good but can sound slightly more template-like. For creative writing, research papers, and long-form content, Claude is often the first choice of professional writers."
  - question: "Which is better for coding?"
    answer: "Both are strong for coding. ChatGPT has historically been more popular with developers and has more available plugins and integrations. Claude handles long codebases better (larger context window) and explains code clearly. For most coding tasks, try both and see which explains your specific problem better."
  - question: "Do I need to pay for either?"
    answer: "Both have free tiers that are genuinely useful. ChatGPT Free gives you access to GPT-4o-mini (capable but not the top model). Claude Free gives you access to Claude with some message limits. Both paid plans (around $20/month) give you access to the best models with higher usage limits. For occasional use, free works fine."
---
...
If you're building something from scratch and asking for help step by step: roughly equivalent.
If you're working with large, complex existing code: Claude has an edge.
