...
faqs:
  ...
  - question: "Can I be tracked without a smartphone?"
    answer: "Yes. CCTV cameras, license plate readers, payment card transactions, and loyalty program data all build a detailed picture of your movements and habits without needing a smartphone. Smartphones just make it faster and more precise."
  - question: "What is the most dangerous AI surveillance technology right now?"
    answer: "Most privacy experts point to the combination of real-time facial recognition paired with mass CCTV networks as the highest-risk pairing. When connected to national ID databases, these systems can track any individual across an entire city in real time."
  - question: "Do VPNs actually protect your privacy?"
    answer: "A VPN protects your internet traffic from your ISP and hides your IP address from websites, but it is not a complete solution. It does not protect you from device-level tracking, app data collection, facial recognition, or data brokers who already have your information."
  - question: "What can I do right now to protect my privacy from AI?"
    answer: "Start with the basics: use encrypted messaging (Signal), review app permissions and revoke anything unnecessary, use a reputable VPN on public networks, and request removal from major data brokers. These steps won't make you invisible, but they significantly reduce your exposure."
---
...
The EU's Digital Identity Wallet, currently rolling out across member states, is designed to link citizens' identities to their banking credentials, medical records, educational history, and travel data in a single system. Proponents call it a modernization of public services. [Euronews fact-checked the privacy claims](https://www.euronews.com/my-europe/2024/04/16/fact-check-is-the-eu-digital-identity-wallet-going-to-strip-away-our-privacy) surrounding the wallet in 2024, finding that cryptographers raised serious concerns about the system's ability to prevent cross-tracking — meaning transactions across different services could be linked back to the same individual despite privacy promises.
