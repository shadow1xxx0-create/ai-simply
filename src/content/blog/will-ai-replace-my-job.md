...
faqs:
  ...
  - question: "Which jobs are least likely to be replaced by AI?"
    answer: "Jobs involving physical presence in unpredictable environments (plumbers, electricians, nurses), high-stakes relationship management (therapists, senior lawyers, executives), genuine creative direction, and skilled trades. AI is a software phenomenon — it doesn't yet translate to physical work reliably."
  - question: "How soon will AI replace jobs?"
    answer: "Most economists expect a gradual shift over 10-20 years, not a sudden cliff. Individual tasks get automated before entire jobs do. The bigger near-term effect is that one person using AI tools can do the work that previously required a small team — meaning fewer junior hires, not mass layoffs of experienced workers."
  - question: "What can I do to protect my career from AI?"
    answer: "Move toward the parts of your job AI can't do: judgment calls, relationship management, creative strategy, and complex coordination. Also learn to use AI as a tool — people who use AI well will outperform those who don't, making them more valuable. The workers displaced by AI will often be replaced not by AI itself, but by workers who use AI."
  - question: "Should I change careers because of AI?"
    answer: "Probably not urgently, but it's worth doing an honest audit. Ask: which tasks in my job are information processing that follows patterns? Those are most at risk. Which tasks require judgment, relationships, or physical presence? Those are safer. If most of your job is the first category, it's worth developing skills in the second."
---
